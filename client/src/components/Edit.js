...
class Edit extends Component {
  ...
  render() {
    let title, author, genre, description, published_year, publisher;
    return (
                            ...
                            <div className="container">
                                <div className="panel panel-default">
                                    ...
                                    <div className="panel-body">
                                        ...
                                        <form onSubmit={e => {
                                            e.preventDefault();
                                            updateBook({ variables: { id: data.book._id, title: title.value, author: author.value, genre:genre.value, description: description.value, publisher: publisher.value, published_year: parseInt(published_year.value) } });
                                            title.value = "";
                                            author.value = "";
                                            genre.value = "";
                                            description.value = "";
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" name="genre" ref={node => {
                                                    genre = node;
                                                }} placeholder="Genre" defaultValue={data.book.genre} />
                                            </div>
                                            <div className="form-group">
