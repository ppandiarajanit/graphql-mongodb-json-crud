                ...
                <div className="container">
                    <div className="panel panel-default">
                        ...
                        <div className="panel-body">
                            ...
                            <form onSubmit={e => {
                                e.preventDefault();
                                addBook({ variables: { title: title.value, author: author.value, genre: genre.value, description: description.value, publisher: publisher.value, published_year: parseInt(published_year.value) } });
                                title.value = "";
                                author.value = "";
                                genre.value = "";
                                description.value = "";
